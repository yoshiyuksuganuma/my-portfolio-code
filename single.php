...
<body <?php body_class(); ?>>
      ...
      <div class="hero hero--bg-pc">
            <div class="hero__inner">
                  <h2 class="hero__page-tit">BLOG</h2>
                  <h3 class="hero__page-tit-ja">ブログ</h3>
            </div>
      </div>
      <!-- /.hero -->
      ...
      ?>
                  <div class="post post--single">
                        <div class="card">
                              ...
                              ?>
                                    ...
                                    <img class="card__img card__img--single" src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php echo $alt; ?>">
                              <?php else : ?>
            ...
            <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="post__archive-back">BLOG一覧へ戻る</a>
                  </div>
                  </div>
